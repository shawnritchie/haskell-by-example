...
/* package haskell-by-example-0.1.0.0 */
#define VERSION_haskell_by_example "0.1.0.0"
#define MIN_VERSION_haskell_by_example(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-by-example-0.1.0.0-AvWof41KC5XGTmmdiwDUVM"

#define CURRENT_PACKAGE_KEY "haskell-by-example-0.1.0.0-AvWof41KC5XGTmmdiwDUVM"
